# ant-skills — Antigravity Skill Catalog

Shared skill library for [namkibok/harness_ant](https://github.com/namkibok/harness_ant).
...
**Welcome to the skills folder!** This is where all 1,300+ specialized AI skills live.
